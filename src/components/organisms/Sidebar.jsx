    ...
    <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="p-4 border-t border-gray-100">
        <div className="flex items-center space-x-3 p-3 bg-surface rounded-lg">
          <div className="w-8 h-8 bg-gradient-to-br from-accent to-emerald-400 rounded-full flex items-center justify-center">
            <ApperIcon name="User" className="text-white" size={16} />
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-gray-900 truncate">Productivity User</p>
            <p className="text-xs text-gray-500">Connected to 6 services</p>
          </div>
        </div>
      </div>
    </div>
